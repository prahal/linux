...
static unsigned int exynos4x12_volt_table[] = {
	1425000, 1400000, 1400000, 1350000, 1350000, 1300000, 1225000, 1175000,
	1125000, 1075000, 1037500, 1012500, 1000000,  987500,  975000,  925000,
	925000,  925000,  900000
};

static struct cpufreq_frequency_table exynos4x12_freq_table[] = {
	{CPUFREQ_BOOST_FREQ, L0, 2000 * 1000},
	{CPUFREQ_BOOST_FREQ, L1, 1920 * 1000},
	{CPUFREQ_BOOST_FREQ, L2, 1800 * 1000},
	{CPUFREQ_BOOST_FREQ, L3, 1704 * 1000},
	{CPUFREQ_BOOST_FREQ, L4, 1600 * 1000},
	{CPUFREQ_BOOST_FREQ, L5, 1500 * 1000},
	{0, L6,  1400 * 1000},
	{0, L7,  1300 * 1000},
	{0, L8,  1200 * 1000},
	{0, L9,  1100 * 1000},
...
static struct apll_freq apll_freq_4412[] = {
	 ...
	 * PLL M, P, S
	 */
	APLL_FREQ(2000, 0, 3, 7, 0, 6, 1, 2, 0, 7, 0, 7, 250, 3, 0),
	APLL_FREQ(1920, 0, 3, 7, 0, 6, 1, 2, 0, 7, 0, 7, 240, 3, 0),
